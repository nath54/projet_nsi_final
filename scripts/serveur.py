...
class Serveur:
    ...
    async def load_perso(self, id_utilisateur):
        ...
        for websocket, data in self.serveurWebsocket.USERS.items():
            if id_utilisateur != perso.id_utilisateur:
                ...
                await self.serveurWebsocket.send(websocket, infos)
