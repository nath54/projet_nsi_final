...
// on teste si le joueur a soumis le formulaire
	if (isset($_POST['inscription']) && $_POST['inscription'] == 'Inscription') {
		...
		if ((isset($_POST['pseudo']) && !empty($_POST['pseudo'])) && (isset($_POST['pseudo']) && !empty($_POST['pseudo'])) && (isset($_POST['pseudo_confirm']) && !empty($_POST['pseudo_confirm'])))
		// on teste les deux mots de passe
		if ($_POST['pseudo'] != $_POST['pseudo_confirm']) {
...
<html lang="fr">
    ...
    <body>
        ...
        <form action="inscription.php" method="post">
            ...
            <label for="mdp_confirm"> Confirmation du mot de passe : </label> <input type="password" name="mdp_confirm" value=" <?php if (isset($_POST['mdp_confirm'])) echo htmlentities(trim($_POST['pass_confirm'])); ?> "> <br /> 
